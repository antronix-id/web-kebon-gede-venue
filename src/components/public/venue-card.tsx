  ...
  return (
    ...
    >
      <Link href={`/venues/${venue.slug}`} className="group block h-full">
        <div className="relative bg-card text-card-foreground rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1.5 border border-border hover:border-primary/50 flex flex-col h-full">
          {/* Image */}
          ...
          <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-1 justify-between">
            <div>
              <h3 className="font-heading text-lg sm:text-xl font-bold text-card-foreground mb-1.5 sm:mb-2 group-hover:text-primary transition-colors">
                {venue.name}
              </h3>
