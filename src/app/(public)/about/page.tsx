...
import { CheckCircle2, MapPin, Compass, Heart } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Tentang Kami",
  description:
    "Profil lengkap Kebon Gede Venue Palembang. Venue outdoor dan indoor seluas 1 hektar dengan keindahan alam tropis dan fasilitas modern berkelas.",
};
    ...
    <div className="pt-16 sm:pt-20">
      ...
      <section className="bg-primary text-primary-foreground py-14 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight text-primary-foreground">
            Pesona Alam Asri untuk Momen Spesial Anda
          </h1>
          <p className="text-primary-foreground/85 text-sm sm:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="relative">
              <div className="relative h-[280px] sm:h-[400px] lg:h-[500px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-4 border-card">
                <Image
                  src="/images/20.png"
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-muted/30 border-b border-border/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {/* Visi */}
            <div className="p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl bg-primary text-primary-foreground shadow-xl flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-primary-foreground/15 flex items-center justify-center text-primary-foreground mb-4 sm:mb-6">
                  <Compass className="w-6 h-6 sm:w-7 sm:h-7" />
                </div>
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-primary-foreground mb-3 sm:mb-4">
                  Visi Kami
                </h3>
            ...
            {/* Misi */}
            <div className="p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl bg-card text-card-foreground border border-border shadow-sm flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mb-4 sm:mb-6">
                  <Heart className="w-6 h-6 sm:w-7 sm:h-7" />
                </div>
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-card-foreground mb-3 sm:mb-4">
                  Misi Kami
                </h3>
                <ul className="space-y-2.5 sm:space-y-3.5 text-muted-foreground text-xs sm:text-sm md:text-base">
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-card text-card-foreground p-3 sm:p-5 md:p-6 rounded-2xl sm:rounded-3xl shadow-sm border border-border overflow-hidden">
            <div className="relative h-[280px] sm:h-[380px] md:h-[460px] rounded-xl sm:rounded-2xl overflow-hidden border border-border/50">
              <iframe
            ...
            <div className="p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
              <div className="flex items-center gap-2.5 sm:gap-3 text-xs sm:text-sm text-card-foreground">
              ...
              <a
                ...
                className="w-full sm:w-auto text-center px-5 py-2.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-xs sm:text-sm font-semibold transition-colors shadow-md shrink-0"
              >
                Buka di Google Maps
              </a>
            </div>
