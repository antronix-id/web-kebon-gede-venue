...
export const metadata: Metadata = {
  ...
  description:
    "Dapatkan tips persiapan pernikahan, panduan memilih venue outdoor di Palembang, serta inspirasi event gathering dari Kebon Gede Venue.",
};
...
export default async function BlogPage() {
  ...
  const publishedPosts =
    livePosts && livePosts.length > 0
      ? livePosts
      : seedPosts.filter((p) => p.status === "published");
